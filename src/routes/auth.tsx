...
function RouteComponent() {
  ...
  return (
    <main
      id="auth-page"
      className="bg-[url(/bg-image.webp)] bg-cover bg-center bg-no-repeat min-h-screen w-full flex justify-center"
    >
      <div className="w-full max-w-3xl flex flex-col justify-between items-stretch">
